...
INSERT INTO employees1 (employee_id, empname, age, salary, department_id) VALUES
(1, 'John', 30, 60000, 101),
...
SELECT employees1.empname,employees1.salary,departments.department_name 
FROM employees1
JOIN departments
...
INSERT INTO products22 (product_id, product_name, price) VALUES
(1, 'Laptop', 1000),
(2, 'Mobile', 500),
(3, 'Tablet', 300),
(4, 'Headphones', 100),
...
INSERT INTO ORDER_ (order_id, customer_name, order_date, order_amount) VALUES
